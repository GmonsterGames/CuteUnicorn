...
//first and second points, between thes points will be created rope
	...
	public Vector3 PosicionInicialPuntoA;
	...
	void Update ()
	{
		...
		if(Input.GetKeyDown(KeyCode.C))
		{
			...
			if (PosicionInicialPuntoA != new Vector3(0,0,0)){
				pointA.transform.position = new Vector3(pointA.transform.position.x, PosicionInicialPuntoA.y, 	pointA.transform.position.z);
			}
