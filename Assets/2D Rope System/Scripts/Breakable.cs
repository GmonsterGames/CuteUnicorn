...
public class Breakable : MonoBehaviour {
	...
	public int CortesNecesariosParaRomper = 1;
	...
	SpriteRenderer elSpriteRenderer;
	Color elColorActual;

	public void UnCorte(){
		CortesNecesariosParaRomper -= 1;
		elColorActual = new Color (1, elColorActual.g- (1 / (float)CortesNecesariosParaRomper), elColorActual.b- (1 / (float)CortesNecesariosParaRomper), 1);
		elSpriteRenderer.color = elColorActual;
	}
	...
	void Awake()
	{
		...
		elSpriteRenderer = gameObject.GetComponent<SpriteRenderer> ();

		elColorActual = elSpriteRenderer.color;
	}
	...
	void OnEnable ()
	{
		...
		jointGot = false;
		breakCount = 0;
		elSpriteRenderer.color = new Color (1, 1, 1, 1);
	...
	void Break()
	{
		...
		transform.parent.gameObject.GetComponent<CadenaCompletaScriptMastrom>().QuemarCadena = true;
